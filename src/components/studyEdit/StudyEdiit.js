...
import createStudyConstants from 'components/createStudy/constants/constants';
...
import HashtagInput from 'components/createStudy/hashtagInput/HashtagInput';
import BoxTemplate from 'components/createStudy/boxTemplate/BoxTemplate';
import RadioBox from 'components/common/radioBox/RadioBox';
import FormTemplate from 'components/createStudy/formTemplate/FormTemplate';
import CharacterCounter from 'components/createStudy/characterCounter/CharacterCounter';
import LoadingPage from 'common/LoadingPage';
import MainButton from 'components/common/mainButton/MainButton';
import ValidationMessage from 'components/createStudy/validationMessage/ValidationMessage';
import DatePicker from 'components/createStudy/datePicker/DatePicker';

import styled, { css } from 'styled-components';
import { InputBox, HelpMessage, defaultLayout } from 'style/CustomStyle';

function StudyEdiit({ onSubmit, loading, onDuplicationCheck, duplicationCheck }) {
...
StudyEdiit.propTypes = {
  onSubmit: PropTypes.func,
  loading: PropTypes.bool,
};

StudyEdiit.defaultProps = {
  loading: false,
  onSubmit: null,
};

export default memo(StudyEdiit);
